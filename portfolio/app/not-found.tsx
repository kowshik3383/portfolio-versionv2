...
export default function NotFound() {
    return (
        <div className="min-h-[80svh] flex flex-col items-center justify-center text-center px-6">
            ...
            <h1 className="font-anton text-6xl sm:text-8xl tracking-tight text-neutral-900 mb-6">
                Lost In Space.
            </h1>
            ...
            <TransitionLink
                href="/"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white font-medium transition-all text-sm shadow-md"
            >
                <ArrowLeft size={16} />
